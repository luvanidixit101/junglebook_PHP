...
// echo "<script>alert('This cage number or feed number is already alloted to other animal');</script>";
    ...
    // else{
        ...
        $query=mysqli_query($con, "insert into  education(main_titale, sub_titale, link_name, description, image) value('$aname','$cnum','$fnum','$desc','$aimg')");
    if ($query) {
...
<head>
    ...
    <title>Add Education Detail</title>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Link Titale</label>
                                                <input type="text" class="form-control" id="aname" name="fnum" aria-describedby="emailHelp" placeholder="Enter Link Titale" value="" required="true">
                                            </div>
                                         ...
                                         <div class="form-group">
                                           ...
                                           <!-- <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="desc" name="desc" aria-describedby="emailHelp" placeholder="Enter Description for education" value="" required="true">
                                            </div>
