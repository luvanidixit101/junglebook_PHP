...
<head>
    ...
    <title>Jungle book System || Dashboard</title>
...
//total indian adult visitors
 $query=mysqli_query($con,"select count(id) as totaladult from tblticindian ");
$result=mysqli_fetch_array($query);
$count_total_visitors=$result['totaladult'];
 ?>  
                                        <h3 class="header-title mb-0">booking for camping</h3>
...
//total indian children visitors
 $query=mysqli_query($con,"select count(NoChildren) as totalchild from tblticindian");
$result=mysqli_fetch_array($query);
$count_total_cvisitors=$result['totalchild'];
 ?>  
                                        <h4 class="header-title mb-0">Today Visitor</h4>
                            ...
                            <div class="single-report">
                                <div class="s-sale-inner pt--30 mb-3">
                                    <div class="s-report-title d-flex justify-content-between">
                                        <?php
//total indian children visitors
 $query=mysqli_query($con,"select count(id) as otp from registretion");
$result=mysqli_fetch_array($query);
$count_total_cvisitors=$result['otp'];
 ?>  
                                        <h4 class="header-title mb-0">Total visitor</h4>
                                        <p style="font-size: 20px;color: red"><?php 
if($count_total_cvisitors==''):
echo "0"; else: 
echo $count_total_cvisitors;
