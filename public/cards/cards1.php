...
$cnt=1;
 ...
 ?>	
			<div class="overlay-content animate slide-left delay-2">
				...
				<p class="animate slide-left pop delay-5" style="color: white; margin-bottom: 2.5rem;"><?php echo htmlentities($row['main_titale']);?></p>
			</div>
		...
		<div class="text">
			<p><img class="inset" src="./admin/images/<?php echo htmlentities($row['image']);?>" alt="" />Trees are woody perennial plants that are a member of the kingdom <em>Plantae</em>. All species of trees are grouped by their genus, family, and order. This helps make identifying and studying trees easier.</p>
