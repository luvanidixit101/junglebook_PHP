                    ...
                    <div class="col-lg-12 col-ml-12">
                        <div class="row">
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Add camping Ticket</h4>
...
$ret=mysqli_query($con,"select * from tbltickettype where id=1");
$cnt=1;
...
$ret=mysqli_query($con,"select * from tbltickettype where id=2");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {
