			...
			<div class="row">
				...
				<div class="col-xs-8 text-right menu-1">
					<ul>
						...
						<li class="active"><a href="portfolio.php">Gellery</a></li>
		...
		<div class="gtco-container">
			<div class="row row-pb-md">
				<div class="col-md-12">
					...
					<?php $query=mysqli_query($conn,"select * from gallery where id=1");
$cnt=1;
 ...
 ?>	
				   ...
				   <!-- <li class="two-third animate-box" data-animate-effect="fadeIn" style="background-image: url(images/tribel01.jpg); ">  -->
						...
						<?php $query=mysqli_query($conn,"select * from gallery where id=2");
$cnt=1;
 ...
 ?>	
						...
						<?php $query=mysqli_query($conn,"select * from gallery where id=3");
 ...
 ?>	
						...
						<?php $query=mysqli_query($conn,"select * from gallery where id=4");
$row=mysqli_fetch_array($query)
?>	
						...
						<?php $query=mysqli_query($conn,"select * from gallery where id=5");
$row=mysqli_fetch_array($query)
?>	
						...
						<?php $query=mysqli_query($conn,"select * from gallery where id=6");
$row=mysqli_fetch_array($query)
?>	
						...
						<?php $query=mysqli_query($conn,"select * from gallery where id=7");
$row=mysqli_fetch_array($query)
?>	
						...
						<?php $query=mysqli_query($conn,"select * from gallery where id=8");
$row=mysqli_fetch_array($query)
?>	
						...
						<?php $query=mysqli_query($conn,"select * from gallery where id=9");
$row=mysqli_fetch_array($query)
?>	
						...
						<?php $query=mysqli_query($conn,"select * from gallery where id=10");
$row=mysqli_fetch_array($query)
?>	
						...
						<?php $query=mysqli_query($conn,"select * from gallery where id=11");
$row=mysqli_fetch_array($query)
?>	
						...
						<?php $query=mysqli_query($conn,"select * from gallery where id=12");
$row=mysqli_fetch_array($query)
?>	
			...
			<div class="row copyright">
				<div class="col-md-12">
					<p class="pull-left">
						...
						<small class="block">Designed by <a href="#services" target="_blank">HarDix</a> Demo Images: <a href="#" target="_blank">Unsplash</a></small>
					</p>
					<p class="pull-right">
